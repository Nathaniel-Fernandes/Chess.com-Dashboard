...
const tacticsResources = () => {
    
    return (
        <div className="resources-section">
        <h2>Tactics</h2>
        <p>Tactics are the building blocks of higher-level chess mastery. Once you can 
            easily spot a fork, pin, skewer, etc., in your sleep, you can start combining 
            them into spectacular combinations and deadly checkmating attacks. Practicing 
            tactics is one of the <strong>fastest</strong> ways to improve because it radically increases your 
            knowledge base and improves your pattern recognition (<a href="https://chessintellect.com/tactics-checkmates-epic-combos/pattern-recognition/" target="_blank" rel="noreferrer noopener">4 Tips to Improve Pattern Recognition in Chess</a>).</p>
            
            <figure className="resource-figure">
                <h3>Best Free Resources</h3>
                <ul>
                    <li><a href="https://www.chess.com/puzzles/rated?ref_id=9730606" rel="noreferrer noopener" target="_blank">Chess.com Tactics</a></li>
                    <li><a href="https://chesspuzzle.net/" rel="noreferrer noopener" target="_blank">ChessPuzzle.net</a></li>
                </ul>
            </figure>
            

            <h3>Top 3 Recommendations</h3>
            <iframe className="amazon-product" style={{width:'120px', height:'240px'}} marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ac&ref=tf_til&ad_type=product_link&tracking_id=chessintellec-20&marketplace=amazon&amp;region=US&placement=0553263153&asins=0553263153&linkId=70267ae8f2b27ee7f209932585da6422&show_border=true&link_opens_in_new_window=true&price_color=333333&title_color=0066c0&bg_color=ffffff">
            </iframe>
